...
class ThugBot(val id: Int, val previousMoves: List<Move>, val gameMap: GameMap) {
    ...
    val logger: Logger = LoggerFactory.getLogger(ThugBot::class.java)
    ...
    fun runOnce(): List<Move> {
        ...
        logger.info("Moves: ${allMoves.joinToString(", ")}")
