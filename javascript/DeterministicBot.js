...
const network = new Networking('PatientBot');
...
//         }
//     } else {
//         const targets = enemies.filter((e) => site.strength > e.site.strength);
//         if (targets.length > 0) {
//             const target = first(orderBy(targets, [(t) => t.site.production, (t) => t.site.strength], ['desc', 'asc']));
